...
Given the campaign name and description, invent a clear tone, vivid opening, and 2-3 starter NPCs.
NPCs must feel unique to THIS setting — invent original names and roles.
...
Produce tone, themes, opening_narration, starting location, and 2-3 distinct starter_npcs
(name, title, personality, goals, knowledge) that fit this world.
"""
    try:
...
def _fallback_npcs() -> list[StarterNpc]:
    return [
        ...
        for s in random_starter_npcs(2)
    ]
